...
export default function Contact() {
	...
	return (
		<div className="flex flex-wrap container justify-between items-center mt-8">
			<div className="w-full md:w-1/2 text-center py-2 px-4">
				...
				>
					<div className="mb-4">
						...
						<input
							...
							type="text"
							required
							className="w-full block rounded-md focus:outline-none border-2 border-gray-400 focus:border-teal-500 transition focus:placeholder:opacity-0 focus:placeholder:transition"
					...
					<div className="mb-4">
						...
						<textarea
							id="message"
							className="w-full resize-none h-[150px] rounded-md focus:outline-none border-2 border-gray-400 focus:border-teal-500 transition"
							name="message"
							onChange={(ev) =>
					...
					<button
						type="submit"
						className="py-4 px-2 bg-teal-800 rounded-xl w-1/3 text-white font-bold hover:bg-teal-700 transition"
					>
						{" "}
						Send{" "}
					</button>
