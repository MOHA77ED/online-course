...
const navigation = [
	...
	{ name: "My Account", to: "/myaccount", current: false },
];
								...
								<div className="flex h-16 items-center justify-between">
									...
									<div className="hidden md:block">
										<div className="ml-4 flex items-center md:ml-6">
											<button
												type="button"
												className="relative rounded-full dark:bg-gray-800 p-1  dark:text-gray-400 text-teal-600 dark:hover:text-white hover:text-teal-500 focus:outline-none dark:focus:ring-2 dark:focus:ring-white dark:focus:ring-offset-2 dark:focus:ring-offset-gray-800"
											>
